...
router.post('/parse', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const { recipe, error: parseError, fromCache, inputType, cacheKey, timings, usage, fetchMethodUsed, cachedMatches } = await parseAndCacheRecipe(input, forceNewParse, isDishNameSearch);
