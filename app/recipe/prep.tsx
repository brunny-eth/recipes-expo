...
const SAMPLE_RECIPES: Record<string, Recipe> = {
  'sample-recipe': {
    ...
    prepSteps: [
      ...
      'Trim any excess fat from the chicken breast',
      'Set up your cooking station with all ingredients within reach'
    ]
  },
  'recipe-1': {
    id: 'recipe-1',
...
export default function PrepScreen() {
  ...
  const toggleStepCompleted = (index: number) => {
    ...
    if (!completedSteps[index] && index === currentStep && index < recipe.prepSteps.length - 1) {
  ...
  return (
    <Animated.View entering={FadeIn.duration(300)} style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Prep Work</Text>
      ...
      <View style={styles.subtitleContainer}>
        ...
        <Text style={styles.progress}>
          {Object.keys(completedSteps).length} of {recipe.prepSteps.length} prep steps completed
        </Text>
      </View>
      ...
      >
        {recipe.prepSteps.map((step: string, index: number) => (
          <Animated.View 
            key={index}
          ...
          >
            ...
            >
              ...
              {index < recipe.prepSteps.length - 1 && (
                <View style={[
      ...
      {Object.keys(completedSteps).length === recipe.prepSteps.length && (
        <Animated.View 
