...
// Using Gemini 1.5 Flash rates
const GEMINI_1_5_FLASH_INPUT_COST_PER_1K_TOKENS = 0.00035;
const GEMINI_1_5_FLASH_OUTPUT_COST_PER_1K_TOKENS = 0.00105;
...
export function estimateCostUSD(usage: StandardizedUsage, provider: 'gemini' | 'openai'): number {
  ...
  if (provider === 'gemini') {
    inputCost = (usage.inputTokens / 1000) * GEMINI_1_5_FLASH_INPUT_COST_PER_1K_TOKENS;
    outputCost = (usage.outputTokens / 1000) * GEMINI_1_5_FLASH_OUTPUT_COST_PER_1K_TOKENS;
