...
const geminiModel = genAI.getGenerativeModel({ model: "models/gemini-1.5-pro-latest" });
...
const testInputs: string[] = [
  ...
  "https://blog.fatfreevegan.cm/2013/06/kale-and-quinoa-salad-with-black-beans.html",
